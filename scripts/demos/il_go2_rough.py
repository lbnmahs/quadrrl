...
# cli_args is in scripts/reinforcement_learning/rsl_rl/
...
from quadrrl.tasks.manager_based.locomotion.legged.config.unitree_go2.rough_env_cfg import UnitreeGo2RoughEnvCfg_PLAY
