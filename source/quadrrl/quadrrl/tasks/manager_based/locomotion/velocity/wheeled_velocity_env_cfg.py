...
class MySceneCfg(InteractiveSceneCfg):
    """Configuration for the terrain scene with a legged or wheeled-legged robot."""
...
@configclass
class ActionsCfg:
    """Default action specifications for the MDP.

    Individual envs may override this (e.g. separate leg / wheel actions).
    """
...
@configclass
class EventCfg:
    """Configuration for events (domain randomization, perturbations)."""
...
@configclass
class RewardsCfg:
    """Base reward terms for the MDP (wheeled & legged robots)."""
...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnvCfg):
    """Base configuration for the velocity-tracking environment (wheeled/legged)."""
    ...
    def __post_init__(self):
        ...
        # curriculum toggle for terrain generator
