...
from quadrrl.robots.zsibot import ZSIBOT_ZSL1W_CFG  # isort: skip


@configclass
class ZsibotZSL1WActionsCfg(ActionsCfg):
    """Action specifications for the ZSL1W MDP."""
...
class ZsibotZSL1WRewardsCfg(RewardsCfg):
    """Reward terms for the ZSL1W MDP."""
...
class ZsibotZSL1WRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    """Rough-terrain velocity-tracking task for Zsibot ZSL1W."""
    ...
    def __post_init__(self):
        ...
        # Rewards (robot_lab ZSL1W rough tuning).
