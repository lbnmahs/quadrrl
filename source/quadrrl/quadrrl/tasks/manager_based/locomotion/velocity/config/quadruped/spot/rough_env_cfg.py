...
class SpotRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Second height scanner used for base-height reward.
        if self.scene.height_scanner_base is not None:
            self.scene.height_scanner_base.prim_path = "{ENV_REGEX_NS}/Robot/body"

        # Spot-specific reward terms are named differently than the default
        # velocity_env_cfg curriculum expects.
        self.curriculum.command_levels_lin_vel.params["reward_term_name"] = "base_linear_velocity"
        self.curriculum.command_levels_ang_vel.params["reward_term_name"] = "base_angular_velocity"
