...
from quadrrl.robots.unitree import UNITREE_GO2W_CFG  # isort: skip


@configclass
class UnitreeGo2WActionsCfg(ActionsCfg):
    """Action specifications for the Go2W MDP (position for legs, velocity for wheels)."""
...
class UnitreeGo2WRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    """Rough-terrain velocity-tracking task for Unitree Go2W."""
    ...
    def __post_init__(self):
        ...
        # Rewards (as in robot_lab Go2W rough config).
