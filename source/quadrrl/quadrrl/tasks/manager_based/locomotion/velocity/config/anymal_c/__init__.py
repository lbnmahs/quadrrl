...
gym.register(
    id="Template-Quadrrl-Velocity-Flat-Anymal-C-v0",
...
gym.register(
    id="Template-Quadrrl-Velocity-Flat-Anymal-C-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-Quadrrl-Velocity-Rough-Anymal-C-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-Quadrrl-Velocity-Rough-Anymal-C-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
