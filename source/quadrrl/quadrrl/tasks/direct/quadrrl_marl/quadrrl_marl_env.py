...
from .quadrrl_marl_env_cfg import QuadrrlMarlEnvCfg


class QuadrrlMarlEnv(DirectMARLEnv):
    cfg: QuadrrlMarlEnvCfg

    def __init__(self, cfg: QuadrrlMarlEnvCfg, render_mode: str | None = None, **kwargs):
