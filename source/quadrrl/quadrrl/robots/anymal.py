...
##
"""Velodyne VLP-16 sensor mounted on the ANYmal robot's base."""
...
##
"""ANYdrive 3.0 with DC actuator model."""
...
##
"""ANYmal-C robot using actuator-net."""
...
"""ANYmal-D robot using actuator-net."""
ANYMAL_D_CFG = ArticulationCfg(
    ...
    # Since there is no publicly available actuator network for ANYmal-D, we use the same network as ANYmal-C.
