# Copyright (c) 2026, Laban Njoroge Mahihu
# All rights reserved.
#
# SPDX-License-Identifier: BSD-3-Clause

"""Configuration for the DeepRobotics robots."""
...
"""Configuration of DeepRobotics robot using DC-Motor actuator model."""
...
DEEPROBOTICS_LITE3_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{QUADRRL_ASSETS_DATA_DIR}/Robots/deeprobotics/lite3_description/urdf/lite3.urdf",
...
DEEPROBOTICS_M20_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{QUADRRL_ASSETS_DATA_DIR}/Robots/deeprobotics/m20_description/urdf/m20.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
